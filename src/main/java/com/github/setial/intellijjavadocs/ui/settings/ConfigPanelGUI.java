...
public class ConfigPanelGUI extends JPanel {
     ...
     */
    public ConfigPanelGUI(JavaDocSettings settings) {
    ...
    private void setupBorders() {
        generalModePanel.setBorder(
                IdeBorderFactory.createTitledBorder("Mode", false, JBUI.insets(0, 0, 0, 10)));
        generalLevelPanel.setBorder(
                IdeBorderFactory.createTitledBorder("Level", false, JBUI.insets(0, 0, 0, 10)));
        generalVisibilityPanel.setBorder(
                IdeBorderFactory.createTitledBorder("Visibility", false, JBUI.insets(0, 0, 0, 0)));
        generalOtherPanel.setBorder(
                IdeBorderFactory.createTitledBorder("Other", false, JBUI.insets(10, 0, 10, 10)));
    }
    ...
    private void setupTemplatesPanel() {
        ...
        classPanel.setBorder(IdeBorderFactory.createTitledBorder("Class level", false, JBUI.insets(0, 0, 10, 0)));
        ...
        methodPanel.setBorder(IdeBorderFactory.createTitledBorder("Method level", false, JBUI.insets(0, 0, 10, 0)));
        ...
        fieldPanel.setBorder(IdeBorderFactory.createTitledBorder("Field level", false, JBUI.insets(0, 0, 0, 0)));
        fieldPanel.add(fieldTemplatesLocalPanel, BorderLayout.CENTER);

        JPanel templatesPanel = new JPanel();
        templatesPanel.setLayout(new GridLayoutManager(4, 1, JBUI.insets(10, 10, 10, 10), -1, -1));
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        panel = new JPanel();
        panel.setLayout(new GridLayoutManager(1, 1, JBUI.insets(0, 0, 0, 0), -1, -1));
        ...
        generalPanel.setLayout(new GridLayoutManager(3, 3, JBUI.insets(10, 10, 10, 10), -1, -1));
        ...
        generalModePanel.setLayout(new GridLayoutManager(3, 1, JBUI.insets(0, 0, 0, 0), -1, -1));
        ...
        generalLevelPanel.setLayout(new GridLayoutManager(3, 1, JBUI.insets(0, 0, 0, 0), -1, -1));
        ...
        generalVisibilityPanel.setLayout(new GridLayoutManager(4, 1, JBUI.insets(0, 0, 0, 0), -1, -1));
        ...
        generalOtherPanel.setLayout(new GridLayoutManager(2, 1, JBUI.insets(0, 0, 0, 0), -1, -1));
