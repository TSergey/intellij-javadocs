...
public class TemplateConfigDialog extends DialogWrapper {
    ...
    protected JComponent createCenterPanel() {
        ...
        panel.setLayout(new GridLayoutManager(2, 1, JBUI.insets(10, 10, 10, 10), -1, -1));
        ...
        namePanel.setBorder(IdeBorderFactory.createTitledBorder("Template regexp", false, JBUI.insets(0, 0, 10, 0)));
        ...
        templatePanel.setBorder(IdeBorderFactory.createTitledBorder("Template content", false, JBUI.insets(0, 0, 0, 0)));
